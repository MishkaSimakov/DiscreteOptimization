...
struct ChangeCustomerFacilityMove {
  size_t customer;
  size_t facility;
};
...
class ChangeCustomerFacilityManager {
 public:
  using Move = ChangeCustomerFacilityMove;
 ...
 public:
  std::optional<ChangeCustomerFacilityMove> generate(
      const ProblemState& problem, const SolutionState& solution) {
